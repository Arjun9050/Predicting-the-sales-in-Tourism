"""
Created on Tuesday September 5 20:09:52 2023

Predicting Sales_Forecasting_on_Tourism_data
...
data = pd.read_csv(r'C:\Users\arjun\OneDrive\Desktop\2023 Sept Fall 3rd sem\Predictive Analytics\Arjun Tourism sales dataset.csv')
data.iloc[:,2].value_counts()

''' Order Date is not in one format. 
So we separate Order Day, Month and Year in different columns, then again combine them in a
...
# 21-Aug-2018 to 31-Aug-2018 sales are 0. Replacing them by 1. as log of 0 is infinite 
sales_day_wise.loc[sales_day_wise['Sales']==0, 'Sales'] = 1
sales_day_wise.dtypes

### Now we move to the Explore Series part after the EDA section
...
## Using the Smoothing Techniques 
...
#### Applying data Pre-Processing step
...
# Forecasting Sales of next 30 days using our Final model
